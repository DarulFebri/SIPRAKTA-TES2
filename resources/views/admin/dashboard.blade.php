...
<head>
    ...
    <title>Dashboard Admin - SIPRAKTA</title>
    ...
    <div class="container">
        <div class="sidebar" id="sidebar">
            ...
            <div class="submenu" id="pengajuan-submenu">
                {{-- Assuming pengajuan sidang PKL and TA are part of the broader 'admin.pengajuan.verifikasi.index' --}}
                <a href="{{ route('admin.pengajuan.sidang.pilih-jenis') }}" style="text-decoration: none;
                color: inherit;">
                ...
                {{-- If you have specific routes for PKL and TA applications, use them here --}}
                {{-- <a href="pengajuansidangpkl.html" style="text-decoration: none; color: inherit;">
                    <div class="submenu-item tooltip">
                        <i class="fas fa-chevron-right"></i>
                ...
                <a href="pengajuansidangta.html" style="text-decoration: none; color: inherit;">
                    <div class="submenu-item tooltip">
                        <i class="fas fa-chevron-right"></i>
                        <span>Sidang TA</span>
            ...
            {{-- Assuming 'Program Studi' might be a separate management section, add a route if available --}}
            ...
            <div class="submenu" id="jadwal-submenu">
                ...
                {{-- If you have specific routes for PKL and TA schedules, use them here --}}
                {{-- <a href="jadwal-sidangpkl.html" style="text-decoration: none; color: inherit;">
                    <div class="submenu-item tooltip">
                        <i class="fas fa-chevron-right"></i>
                        <span>Sidang PKL</span>
                        <span class="tooltiptext">Sidang PKL</span>
                ...
                <a href="jadwal-sidangta.html" style="text-decoration: none; color: inherit;">
                    <div class="submenu-item tooltip">
                        <i class="fas fa-chevron-right"></i>
                        <span>Sidang TA</span>
                        <span class="tooltiptext">Sidang TA</span>
            ...
            {{-- Assuming 'Notifikasi' might have a dedicated route, add it if available --}}
            <a href="{{ route('admin.activities.index') }}" style="text-decoration: none; color: inherit;">
                <div class="menu-item tooltip">
                    <i class="fas fa-bell"></i>
                    <span>Log Aktivitas</span> {{-- Renamed to better reflect available route --}}
        ...
        <div class="main-content" id="mainContent">
                ...
                <div class="header-content">
                    ...
                    <div class="user-profile" id="userProfile">
                        ...
                        <div class="profile-dropdown" id="profileDropdown">
                            {{-- Add route for Ubah Sandi if available --}}
            ...
            <div class="card-container">
                ...
                {{-- Placeholder, add actual route if available --}}
