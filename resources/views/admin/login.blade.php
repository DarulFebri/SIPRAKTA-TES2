...
<head>
    ...
    {{-- Font Awesome mungkin masih dibutuhkan untuk ikon --}}
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    {{-- Poppins font sudah ada di auth_styles.css, tidak perlu diulang --}}
</head>
<body>
    ...
    <div class="login-container">
        <div class="header">
            {{-- Tambahkan logo seperti di halaman mahasiswa --}}
    ...
    {{-- Anda bisa menambahkan bagian ini jika ingin fitur modal seperti di auth_layout.blade.php --}}
    <script>
